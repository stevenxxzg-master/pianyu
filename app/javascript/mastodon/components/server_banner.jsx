    ...
    return (
      <div className='server-banner'>
        <div className='server-banner__introduction'>
          <FormattedMessage id='server_banner.is_one_of_many' defaultMessage='{domain} is one of many independent communities connected through the fediverse.' values={{ domain: <strong>{domain}</strong> }} />
        </div>
