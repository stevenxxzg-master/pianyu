    ...
    return (
      <div className='status__action-bar'>
        <div className='status__action-bar__button-wrapper'>
          <IconButton className='status__action-bar__button icon-button--pianyu' title={replyTitle} icon='reply' iconName='action.reply' iconState={replyIconState} onClick={this.handleReplyClick} counter={status.get('replies_count')} />
        </div>
        <div className='status__action-bar__button-wrapper'>
          <BoostButton status={status} counters={withCounters} />
        </div>
        <div className='status__action-bar__button-wrapper'>
          <IconButton className='status__action-bar__button icon-button--pianyu star-icon' animate active={status.get('favourited')} title={favouriteTitle} icon='star' iconName='action.favourite' iconState={status.get('favourited') ? 'active' : 'default'} onClick={this.handleFavouriteClick} counter={withCounters ? status.get('favourites_count') : undefined} />
        </div>
        <div className='status__action-bar__button-wrapper'>
          <IconButton className='status__action-bar__button icon-button--pianyu bookmark-icon' disabled={!signedIn} active={status.get('bookmarked')} title={bookmarkTitle} icon='bookmark' iconName='action.bookmark' iconState={status.get('bookmarked') ? 'active' : 'default'} onClick={this.handleBookmarkClick} />
        </div>
