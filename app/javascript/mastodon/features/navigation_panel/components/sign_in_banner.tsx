        ...
        <p>
          <strong>
            <FormattedMessage
              ...
              defaultMessage='A place to drop in, catch up, and say hi.'
            />
          </strong>
        </p>
        <p>
          <FormattedMessage
            ...
            defaultMessage='Follow people across communities, read in chronological order, and join in whenever you like.'
          />
        </p>
        <a
          href={sso_redirect}
