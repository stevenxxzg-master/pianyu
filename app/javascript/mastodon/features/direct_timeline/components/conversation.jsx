...
import { secondaryPageClasses } from 'mastodon/components/secondary_page';
...
const getAccounts = createSelector(
  ...
  (accounts, accountIds) => accountIds.map((id) => accounts.get(id)),
);
    ...
    <Hotkeys handlers={handlers}>
      <div
        className={classNames(
          ...
          secondaryPageClasses.conversationCard,
          { unread },
        )}
        tabIndex={0}
      >
        <div
          className={classNames(
            ...
            secondaryPageClasses.conversationAvatar,
          )}
          onClick={handleClick}
          role='presentation'
        >
        ...
        <div
          className={classNames(
            ...
            secondaryPageClasses.conversationContent,
          )}
        >
          <div className={secondaryPageClasses.conversationMeta}>
            <AnimateEmojiProvider
              className={classNames(
                'conversation__content__names',
                secondaryPageClasses.conversationNames,
              )}
            >
              <FormattedMessage
            ...
            <div
              className={classNames(
                ...
                secondaryPageClasses.conversationTime,
              )}
            >
          ...
          {lastStatus.get('media_attachments').size > 0 && (
            <AttachmentList compact media={lastStatus.get('media_attachments')} />
          )}

          <div
            className={classNames(
              'status__action-bar',
              secondaryPageClasses.conversationActions,
            )}
          >
            <IconButton
