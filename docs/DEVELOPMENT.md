...
- For release sign-off thresholds covering homepage load, post publish, notifications, timeline scrolling, and background jobs, use the [Release performance baseline](./RELEASE_PERFORMANCE_BASELINE.md).
